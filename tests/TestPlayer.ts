...
export class TestPlayer extends Player {
  ...
  public countTags(tag: Tag, includeEventsTags:boolean = false, includeWildcardTags:boolean = true): number {
    if (this.tagsForTest !== undefined) {
      return this.tagsForTest[tag] || 0;
    }
    return super.countTags(tag, includeEventsTags, includeWildcardTags);
  }
}
