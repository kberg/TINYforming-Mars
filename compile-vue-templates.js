...
checkComponent(
  ...
  [
    'ui', 'hide_hand', 'hide_cards', 'hide_tag_overview',
    'hide_top_bar', 'small_cards', 'remove_background', 'magnify_cards',
    'magnify_card_descriptions', 'show_alerts', 'hide_log',
    'lang', 'langs', 'enable_sounds', 'smooth_scrolling', 'hide_tile_confirmation', 'show_discount_on_cards',
    'learner_mode',
  ],
);
checkComponent(
